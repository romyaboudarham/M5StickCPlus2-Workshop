...
void loop() {
  ...
  sprite->fillCircle(circleX, circleY, circleRadius, VIOLET);
  /*** MOVE CIRCLE - END ***/
  ...
  sprite->fillTriangle(triangle_X0, 135, triangle_X1, 100, triangle_X2, 135, YELLOW); // x0, y0, x1, y1, x2, y2, color
  /*** MOVE TRIANGLE - BEGIN ***/
  ...
  sprite->fillEllipse(ellipse_X, ellipse_Y, ellipse_RadiusX, ellipse_RadiusY, ORANGE); // x (center), y (center), radius-x, radius-y, color
  /*** MOVE ELLIPSE - END ***/
